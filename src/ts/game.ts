...
// キャラクターへのコマンド設定
(characters[1] as Friend).command = "enemyCommand";
(characters[1] as Friend).target = characters[searchCharacterByName("トロル")[0]] as Troll;
(characters[2] as Friend).command = "enemyCommand";
(characters[2] as Friend).target = characters[searchCharacterByName("ドラゴン")[0]] as Dragon;
(characters[3] as Friend).command = "recoveryCommand";
